...
class ActivitiesToActivityAdapter(activityCategoryKey: String) : RecyclerView.Adapter<ActivityView>()  {
    ...
    init {
        ...
        DAOActivityCategory().getActivitiesForCategory(activityCategoryKey).addValueEventListener(activitiesListener)
    }
